    ...
    <footer className="border-t border-border/60 mt-24">
      <div className="mx-auto max-w-6xl px-6 py-10 flex flex-col md:flex-row gap-4 items-center justify-between">
        <p className="text-sm text-muted-foreground">
          © {new Date().getFullYear()} Neha Mary Pramod. Crafted with care.
        </p>
        <div className="flex items-center gap-4 text-muted-foreground">
          <a href="mailto:hello@nehamary.dev" aria-label="Email" className="hover:text-foreground transition-colors">
